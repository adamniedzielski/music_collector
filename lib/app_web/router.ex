defmodule MusicCollectorWeb.Router do
  use MusicCollectorWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MusicCollectorWeb.Layouts, :root}
  ...
  scope "/", MusicCollectorWeb do
    ...
    resources "/playlists", PlaylistController do
      ...
      delete "/playlist_bought_tracks/:id", PlaylistBoughtTrackController, :delete
    end
  ...
  if Application.compile_env(:app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MusicCollectorWeb.Telemetry
